...
public:
	...
	void NTT_FPGA(uint64_t* a, long np);
	void INTT(uint64_t* a, long index);
	void INTT_FPGA(uint64_t* a, long np);
	...
	void multDNTT_FPGA(ZZ* x, uint64_t* ra, uint64_t* rb, long np, const ZZ& QQ);
	...
	//void mulModBarrett_FPGA(uint64_t *r, uint64_t *a, uint64_t *b, uint64_t p, uint64_t pr);
	//void mulModBarrett_FPGA(uint64_t modOut_addr, uint64_t *a, uint64_t *b, uint64_t p, uint64_t pr);
	void mulModBarrett_FPGA(uint64_t *r, uint64_t *a, uint64_t *b, uint32_t index,uint32_t mode);

	void mulModBarrett_DMA_FPGA(uint64_t r_addr, uint64_t a_addr, uint64_t b_addr, uint64_t p, uint64_t pr);
