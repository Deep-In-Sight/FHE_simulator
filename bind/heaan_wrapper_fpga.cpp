...
PYBIND11_MODULE(HEAAN_fpga, m)
{
	...
	py::class_<Scheme>(m, "Scheme")
        ...
        .def("multAndEqual_FPGA", &Scheme::multAndEqual_FPGA)
	...
	py::class_<Ring>(m, "Ring")
        ...
        .def("multDNTT_FPGA", &Ring::multDNTT_FPGA)
	...
	py::class_<RingMultiplier>(m, "RingMultiplier")
        ...
        .def("NTT_FPGA", &RingMultiplier::NTT_FPGA)
		.def("INTT", &RingMultiplier::primeTest)
        .def("INTT_FPGA", &RingMultiplier::primeTest)
        ...
        .def("multDNTT_FPGA", &RingMultiplier::multDNTT_FPGA)
        ...
        .def("mulModBarrett_FPGA", &RingMultiplier::mulModBarrett_FPGA)
		.def("mulModBarrett_DMA_FPGA", &RingMultiplier::mulModBarrett_DMA_FPGA)
