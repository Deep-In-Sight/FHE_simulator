...
public:
	...
	void init(string root_path);
	void init(string root_path, string enckeyname, string mulkeyname,string conjkeyname,string rotkeyname);
	void setEncKeyName(string fname);
	void setMulKeyName(string fname);
	void setConjKeyName(string fname);
	void setRotKeyName(string fname);
	void addKeys(SecretKey& secretKey);
	string getSerKeyPath(int idx);
	...
	void reconstruct(Ciphertext& cipher);
	void INTT(Ciphertext& cipher);

	void multByConstVecAndEqual(Ciphertext& cipher, complex<double>* cnstVec, long logp);
	void multByConstVecAndEqual2(Ciphertext& cipher, complex<double>* cnstVec, long logp);

	void multByConstVec(Ciphertext& res, Ciphertext& cipher, double* cnstVec, long logp);

	void multByConstVecAndEqual(Ciphertext& cipher, double* cnstVec, long logp);    
	void multByConstVecAndEqual2(Ciphertext& cipher, double* cnstVec, long logp);    
