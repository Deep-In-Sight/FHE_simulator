...
public:
	...
	void multNoNTT(uint64_t* ra, uint64_t* rb, long np, const ZZ& q);
	...
	//  NEW
	//----------------------------------------------------------------------------------
	void reconstruct(ZZ* a, uint64_t* ra, long np, const ZZ& q);
	void INTT(uint64_t* rxi, long np);
    ...
    void sampleHWT(ZZ* res, long* indices, long* values);
